...
const lorem = new LoremIpsum({		// Configuring the Lorem Ipsum generator.
...
function randomPass(randomLength = false, length = 8){
	...
	const chars = "abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXZY1234567890!@#$%^&*()_+{}[.]:'";	// Valid List of Characters to form the password out of.

	let randomPassword = "", randomLen;
